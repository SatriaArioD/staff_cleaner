        ...
        children: [
          pw.Column(
            ...
            children: [
              ...
              V(8.0),
              pw.Text("PT.YUK BERSIHIN SEJAHTERA"),
...
pw.Widget _contentTerms(pw.Context context) {
  return pw.Column(
    ...
    children: [
      ...
      pw.Text("*Pembayaran dapat melalui rekening:"),
      pw.Padding(
          padding: const EdgeInsets.only(left: 8.0),
          child: pw.Text("BCA 0948589772 PT. YUK BERSIHIN SEJAHTERA")),
      pw.Text(
          "*Setelah pembayaran dilakukan, mohon konfirmasi ke Customer Service kami di Whatsapp 08111129089"),
      pw.Text(
          "*Vacuum atau cuci matras 2 sisi (atas & bawah) akan dikenakan biaya tambahan 50% dari harga normal"),
      pw.Text(
          "*Mohon melakukan pengecekan ulang sebelum cleaner meninggalkan tempat"),
      pw.Text("*Kami tidak melayani komplain di atas 1x24 jam"),
      pw.Text(
          "*Jika terjadi kerusakan pada item yang dibersihkan, penggantian maksimal 2 kali lipat dari biaya jasa yang dikerjakan oleh staf kami"),
      pw.Text(
          "*Untuk menjaga kesehatan keluarga, sebaiknya deep hydroallergic vacuum dilakukan setiap 3 bulan sekali"),
      Text('Terima Kasih!',
          style: TextStyle(
            letterSpacing: 2,
            wordSpacing: 3,
